...
export default function DashboardPage() {
  ...
  const recentActivity = useMemo(() => {
    ...
    const studyActs = [...progress]
      ...
      .map((p) => ({
        type: "study",
        label: `Studied: ${COMPONENT_LABELS[p.component] ?? p.component}`,
        date: p.updated_at,
      }));
  ...
  return (
    ...
    >
      <div style={{ maxWidth: "900px" }}>
          ...
          <div>
            ...
            >
              {studyPct === 0
                ...
                : studyPct === 100
                  ? "🎉 You've completed all components!"
                  : `${studyPct}% through the curriculum`}
            </p>
          </div>
        </div>
        ...
        >
          {[
            { label: "Quizzes taken", value: scores.length, color: "#5b9bd5" },
            {
              label: "Best score",
          ...
          >
            ...
            {scores.length >= 2 && (
              ...
              >
                ...
                >
                  {formatDate(scores[scores.length - 1]?.created_at)}
                </span>
                <span
                  style={{ fontSize: "9px", color: "rgba(180,210,240,.3)" }}
                >
